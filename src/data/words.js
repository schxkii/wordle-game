const words = [
    "apple", "grape", "peach", "berry", "melon", "mango", "lemon", "plum", "kiwi", "cherry",
    "orange", "banana", "papaya", "apricot", "coconut", "date", "fig", "guava", "lime", "nectarine",
    ...
    "brief", "bring", "broad", "broke", "brown", "build", "carry", "catch", "cause", "chain",
